...
//    );
    ...
    @POST("http://120.26.90.186:8080/message/addMessage")
    Observable<HttpResult<String>> addSence(@Query("id") Integer id);

    @GET("http://120.26.90.186:8080/message/getAllMessage")
    Observable<HttpResult<List<MessageEntity>>> getAllMessage();

    @GET(" http://120.26.90.186:8080/message/deleteAllMessage")
    Observable<HttpResult<String>>deleteAllMessage();
}
